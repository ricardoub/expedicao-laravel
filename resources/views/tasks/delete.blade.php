...
@section('panel-body')
  ...
  <div class="">
    <div class="form-group col-md-8 col-md-offset-2">
      ...
      {{ Form::model($model, ['route' => [$actions['form']['destroy'], $model->id]]) }}
        @include('tasks.form')
        ...
        <div class="text-center">
          ...
          <div class="btn-group" >
            ...
            @include('partials.buttons.form-submit', [
              'btnName'  => $buttons['destroy']['name'],
              'btnLink'  => $buttons['destroy']['link'],
              'btnIcon'  => $buttons['destroy']['icon'],
              'btnClass' => $buttons['destroy']['class'],
            ])
          </div>
        </div>
